						...
						if (this.chemin.itineraire.size() > 1) {
							...
							if (dernierePos[0] - avantDerniere[0] == 0) { // déplacement
								...
								if (dernierePos[1] - avantDerniere[1] < 0) { // de
									...
									p2 = Grille.getInstance().pheromone(this.posi, Math.abs(this.posj - 1),
											null);
									p3 = Grille.getInstance().pheromone(-Math.abs(this.posi + 1 - 49) + 49,
											posj, null);
									...
									p1 = Grille.getInstance().pheromone(-Math.abs(this.posi + 1 - 49) + 49,
											posj, null);
									p2 = Grille.getInstance().pheromone(this.posi,
											-Math.abs(this.posj + 1 - 49) + 49, null);
								...
								if (dernierePos[0] - avantDerniere[0] < 0) { // du
																				...
																				// le
																				// haut
									p1 = Grille.getInstance().pheromone(this.posi, Math.abs(this.posj - 1),
											null);
									p2 = Grille.getInstance().pheromone(Math.abs(this.posi - 1), this.posj,
											null);
									...
									p1 = Grille.getInstance().pheromone(this.posi, Math.abs(this.posj - 1),
											null);
									p2 = Grille.getInstance().pheromone(-Math.abs(this.posi + 1 - 49) + 49,
											this.posj, null);
									p3 = Grille.getInstance().pheromone(this.posi,
											-Math.abs(this.posj + 1 - 49) + 49, null);
							...
							p3 = Grille.getInstance().pheromone(-Math.abs(this.posi + 1 - 49) + 49, posj,
									null);
							p4 = Grille.getInstance().pheromone(this.posi,
									-Math.abs(this.posi + 1 - 49) + 49, null);
